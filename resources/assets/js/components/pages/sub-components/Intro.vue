<template lang="html">
   <article id="intro" class="">
      <p>Hi. This is is my first website built on the Laravel PHP framework. Right now, it is very much a work in progress which I will be adding to in the days and weeks to come. Using backpack base, I built out an admin panel then built out the front end.</p>
